aws lightsail create-instances --instance-names us-east-2-1 --availability-zone us-east-2a --blueprint-id ubuntu_22_04 --bundle-id small_3_0 --user-data file:///root/AWS-AMD-internetincome.sh --region us-east-2
timeout 10
...
aws lightsail create-instances --instance-names us-east-2-2 --availability-zone us-east-2a --blueprint-id ubuntu_22_04 --bundle-id small_3_0 --user-data file:///root/AWS-AMD-internetincome.sh --region us-east-2
timeout 10
...
aws lightsail create-instances --instance-names us-east-2-3 --availability-zone us-east-2a --blueprint-id ubuntu_22_04 --bundle-id small_3_0 --user-data file:///root/AWS-AMD-internetincome.sh --region us-east-2
timeout 10
...
aws lightsail create-instances --instance-names us-east-2-4 --availability-zone us-east-2a --blueprint-id ubuntu_22_04 --bundle-id small_3_0 --user-data file:///root/AWS-AMD-internetincome.sh --region us-east-2
timeout 10
