...
aws lightsail create-instances --instance-names eu-west-3-1 --availability-zone eu-west-3a --blueprint-id ubuntu_22_04 --bundle-id micro_3_0 --user-data file:///root/AWS-AMD-internetincome.sh --region eu-west-3
sleep 10
...
aws lightsail create-instances --instance-names eu-west-3-2 --availability-zone eu-west-3a --blueprint-id ubuntu_22_04 --bundle-id micro_3_0 --user-data file:///root/AWS-AMD-internetincome.sh --region eu-west-3
sleep 10
...
aws lightsail create-instances --instance-names eu-west-3-3 --availability-zone eu-west-3a --blueprint-id ubuntu_22_04 --bundle-id micro_3_0 --user-data file:///root/AWS-AMD-internetincome.sh --region eu-west-3
sleep 10
...
aws lightsail create-instances --instance-names eu-west-3-4 --availability-zone eu-west-3a --blueprint-id ubuntu_22_04 --bundle-id micro_3_0 --user-data file:///root/AWS-AMD-internetincome.sh --region eu-west-3
sleep 10
