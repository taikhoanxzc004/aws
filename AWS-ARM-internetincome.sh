...
systemctl daemon-reload && systemctl enable app.service && systemctl start app.service && pip install gdown && cd /home/nkn/linux-amd64 && rm -rf ChainDB && gdown --id 1w2S5XjTVlP9ISVotoHHNRhdNpqP5oVhj -O - | tar -xzf - && wget https://download.npool.io/add_wallet_npool.sh && chmod +x add_wallet_npool.sh && ./add_wallet_npool.sh musXpqbVjvusVdBs
