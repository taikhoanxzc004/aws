...
aws lightsail create-instances --instance-names ap-northeast-2-1 --availability-zone ap-northeast-2a --blueprint-id ubuntu_22_04 --bundle-id micro_3_0 --user-data file:///root/AWS-AMD-internetincome.sh --region ap-northeast-2
sleep 10
...
aws lightsail create-instances --instance-names ap-northeast-2-2 --availability-zone ap-northeast-2a --blueprint-id ubuntu_22_04 --bundle-id micro_3_0 --user-data file:///root/AWS-AMD-internetincome.sh --region ap-northeast-2
sleep 10
...
aws lightsail create-instances --instance-names ap-northeast-2-3 --availability-zone ap-northeast-2a --blueprint-id ubuntu_22_04 --bundle-id micro_3_0 --user-data file:///root/AWS-AMD-internetincome.sh --region ap-northeast-2
sleep 10
...
aws lightsail create-instances --instance-names ap-northeast-2-4 --availability-zone ap-northeast-2a --blueprint-id ubuntu_22_04 --bundle-id micro_3_0 --user-data file:///root/AWS-AMD-internetincome.sh --region ap-northeast-2
sleep 10
