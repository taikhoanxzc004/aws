...
aws ec2 run-instances --image-id ami-058140b4ea0516c42 --key-name KeyPair --security-groups Group --instance-type c6g.medium --count 4 --block-device-mappings 'DeviceName=/dev/sda1,Ebs={VolumeSize=100}' --user-data file:///root/AWS-ARM-internetincome.sh" --region us-west-2
