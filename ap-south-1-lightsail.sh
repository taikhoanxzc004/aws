#!/bin/bash
﻿aws lightsail create-instances --instance-names ap-south-1-1 --availability-zone ap-south-1a --blueprint-id ubuntu_22_04 --bundle-id small_3_0 --user-data file:///root/AWS-AMD-internetincome.sh --region ap-south-1
sleep 10
...
aws lightsail create-instances --instance-names ap-south-1-2 --availability-zone ap-south-1a --blueprint-id ubuntu_22_04 --bundle-id small_3_0 --user-data file:///root/AWS-AMD-internetincome.sh --region ap-south-1
sleep 10
...
aws lightsail create-instances --instance-names ap-south-1-3 --availability-zone ap-south-1a --blueprint-id ubuntu_22_04 --bundle-id small_3_0 --user-data file:///root/AWS-AMD-internetincome.sh --region ap-south-1
sleep 10
...
aws lightsail create-instances --instance-names ap-south-1-4 --availability-zone ap-south-1a --blueprint-id ubuntu_22_04 --bundle-id small_3_0 --user-data file:///root/AWS-AMD-internetincome.sh --region ap-south-1
sleep 10
