#!/bin/bash
﻿aws lightsail create-instances --instance-names ap-northeast-1-1 --availability-zone ap-northeast-1a --blueprint-id ubuntu_22_04 --bundle-id micro_3_0 --user-data file:///root/AWS-AMD-internetincome.sh --region ap-northeast-1
sleep 10
...
aws lightsail create-instances --instance-names ap-northeast-1-2 --availability-zone ap-northeast-1a --blueprint-id ubuntu_22_04 --bundle-id micro_3_0 --user-data file:///root/AWS-AMD-internetincome.sh --region ap-northeast-1
sleep 10
...
aws lightsail create-instances --instance-names ap-northeast-1-3 --availability-zone ap-northeast-1a --blueprint-id ubuntu_22_04 --bundle-id micro_3_0 --user-data file:///root/AWS-AMD-internetincome.sh --region ap-northeast-1
sleep 10
...
aws lightsail create-instances --instance-names ap-northeast-1-4 --availability-zone ap-northeast-1a --blueprint-id ubuntu_22_04 --bundle-id micro_3_0 --user-data file:///root/AWS-AMD-internetincome.sh --region ap-northeast-1
sleep 10
