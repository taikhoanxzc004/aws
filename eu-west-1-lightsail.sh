#!/bin/bash
﻿aws lightsail create-instances --instance-names eu-west-1-1 --availability-zone eu-west-1a --blueprint-id ubuntu_22_04 --bundle-id micro_3_0 --user-data file:///root/AWS-AMD-internetincome.sh --region eu-west-1
sleep 10
...
aws lightsail create-instances --instance-names eu-west-1-2 --availability-zone eu-west-1a --blueprint-id ubuntu_22_04 --bundle-id micro_3_0 --user-data file:///root/AWS-AMD-internetincome.sh --region eu-west-1
sleep 10
...
aws lightsail create-instances --instance-names eu-west-1-3 --availability-zone eu-west-1a --blueprint-id ubuntu_22_04 --bundle-id micro_3_0 --user-data file:///root/AWS-AMD-internetincome.sh --region eu-west-1
sleep 10
...
aws lightsail create-instances --instance-names eu-west-1-4 --availability-zone eu-west-1a --blueprint-id ubuntu_22_04 --bundle-id micro_3_0 --user-data file:///root/AWS-AMD-internetincome.sh --region eu-west-1
sleep 10
